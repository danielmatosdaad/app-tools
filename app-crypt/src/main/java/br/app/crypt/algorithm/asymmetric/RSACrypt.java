package br.app.crypt.algorithm.asymmetric;
...
public class RSACrypt extends AsymmetricCrypterImpl{
	...
	/**
	 * Cria uma nova instancia de RSACrypt, com chaves geradas no momento da
	 * construção e utilizando o padrão de algoritmo simétrico AES de 128 bits
	 * na chave.
	 * 
	...
	/**
	 * Cria uma nova instancia de RSACrypt, as chaves indicadas e utilizando o
	 * padrão de algoritmo simétrico AES de 128 bits na chave.
	 * 
	 * @param serializedPublicKey
	 *            - Chave publica serializada (objeto do tipo PublicKey
	 *            serializado)
	 * @param serializedPrivateKey
	 *            - Chave privada serializada (objeto do tipo PrivateKey
	 *            serializado)
	 * @throws InvalidKeyException
	 * @throws InvalidKeySpecException
	 * @throws IOException
	 * @throws ClassNotFoundException
	 */
	public RSACrypt(final KeyPair keys)
	 ...
	 * @throws ClassNotFoundException
	 */
	public RSACrypt(final byte[] serializedPublicKey, final byte[] serializedPrivateKey)
			throws InvalidKeyException, InvalidKeySpecException, IOException, ClassNotFoundException {
	 ...
	 * @throws ClassNotFoundException
	 */
	public RSACrypt(final byte[] serializedPublicKey)
			throws InvalidKeyException, InvalidKeySpecException, IOException, ClassNotFoundException {
